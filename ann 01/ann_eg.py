# -*- coding: utf-8 -*-
"""
Created on Wed Aug 28 22:44:47 2019
...
# EG Fitting  the ANN to the traing set
classifier.fit(X_train, y_train, batch_size = 10, epochs =100)

# EG Part 3 Makşng the predictiions and evaluating thr model
...
# import classifier_builder_eg

classifier = KerasClassifier(build_fn = build_classifier, batch_size = 10, epochs =100 )
accuracies = cross_val_score(estimator = classifier, X = X_train, y = y_train, cv = 10, n_jobs = -1)

finishTime = pd.datetime.now()
print(startTime)
print(finishTime)
